...
<head>
<title>Gmu e-Library|| Our Partners</title>
...
<div id="shell">
    ...
    <div class="big-navigation">
      <ul>
        ...
        <li class="big-navigation-blue">
          ...
          <div class="data">
            <h3><a href="#">Project Management Areaa</a></h3>
            <p>What Your Project to be Managed Checkout this Section</p>
  ...
  <div id="main">
    <br/><br/>
    <h2><a href="partners.php">Our Partners</a></h2><table width="100%" border="1" id="box-table-a">
    <tr width="100%">
      <td width="40%"><a href="edit/allowance+edit.php"><img src="../images/payment.png" width="91" height="91" /><br/>
        partner1</a></td>
            <td width="40%"><a href="edit/allowance+edit.php"><img src="../images/payment.png" width="91" height="91" /><br/>
        partner1</a></td>
            <td width="40%"><a href="edit/allowance+edit.php"><img src="../images/payment.png" width="91" height="91" /><br/>
