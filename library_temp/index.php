...
<div id="shell">
  ...
  <div id="navigation">
    <ul>
      ...
      <li><a href="signup.php">SIGNUP FOR SIMPLIFIED LIBRARY</a></li>
            <li><a href="../schools/index.php">GO TO SCHOOL LIBRARY</a></li>
...
if(isset($_POST['button'])){
	...
	$select="SELECT * FROM `library_reg` WHERE `username`='$uname' AND `password`='$pword'";
...
$choose=mysql_query("Select `id` FROM `library_reg` WHERE `username`='$uname' AND `password`='$pword'");
...
<div id="bar"><h2>Login here</h2><img src="../forum/Arrow.png" style="	position:absolute; top:316px; right:-200px; left:500px; z-index:15;" /></div>
...
<table border="0" >
<tr class="none">
            	<td height="37" ><p style="color:#FFF; font-family:'Courier New', Courier, monospace; size:auto;">Username:</p></label><br/><input class="data" id="input" type="text" size="40" maxlength="15" width="30" name="username" autocomplete="off"/></td>
            </tr>
<tr class="none">
