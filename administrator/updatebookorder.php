...
$id=$_POST['id'];
	...
	$select="UPDATE `book_orders` SET `depositors_name` = '$despositorsname',`tellerno` = '$tellernumber' WHERE `id` =$id LIMIT 1";
	$query=mysql_query($select) or die("ERROR:".mysql_error());
header("location:manage_bookshop_order.php?id=$id");
