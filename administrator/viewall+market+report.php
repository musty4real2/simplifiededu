...
<?php
  ...
  $q = "SELECT * FROM `marketers_report`";
  $r = mysql_query ($q);
...
?>
        <?php
		$get="SELECT * FROM `marketers_report` ORDER BY `id` DESC LIMIT $start, $display ";
...
<legend><b>View All www.simplifiededu.com Marketers Report  </b><?php
