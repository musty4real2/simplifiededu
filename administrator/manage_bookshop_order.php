...
<div id="shell">
  ...
  <div id="main">
    ...
    <br/><br/>
    <h2><a href="index.php">Simplified Education e-Library </a></h2>
...
?>
        <?php
		$get="SELECT * FROM `book_orders` WHERE `depositors_name`='' and `tellerno`='' ORDER BY `id` DESC LIMIT $start, $display ";
...
<legend><b>View All Book Orders</b><?php
...
$s=1;
	...
	?>
    <td><?php echo $s++; ?></td>
    <td><?php echo $object->getBook($bkid);  ?>
    <td><?php echo $l['name'];?></td>
        ...
        <td><?php echo $l['email'];?></td>
         ...
         <?php echo "<td><a href='updatebookorder.php?id=$id'>Update Order</a></td>"; ?> 
    <?php echo "<td><a href='manage_bookshop_order.php?deleteid3=$id'>Delete</a></td>"; ?> 
 </tr>
 <?php 
}
}
