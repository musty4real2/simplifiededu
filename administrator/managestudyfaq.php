...
echo 'Do You Really Want To Turn On the visibility of these faq if you do the suggestion would be available ? <a href="managestudyfaq.php?yesdelete='.$_GET['deleteid'].'">Yes </a>| <a href="managestudyfaq.php">No</a>';
exit();
...
if(isset($_GET['yesdelete'])){
	...
	header("location:managestudyfaq.php");
	exit();
}
	if(isset($_GET['deleteid2'])){
echo 'Do You Really Want To Turn Off the visibility of these suggestion if you do the suggestion would not be available in the page  ? <a href="managestudyfaq.php?yesdelete2='.$_GET['deleteid2'].'">Yes </a>| <a href="managestudyfaq.php">No</a>';
exit();
...
echo 'Do You Really Want To Delete these suggestion if you do the suggestion would not be available? <a href="managestudyfaq.php?yesdelete3='.$_GET['deleteid3'].'">Yes </a>| <a href="managestudyfaq.php">No</a>';
exit();
...
$s=1;
   ...
   <?php echo "<td><a href='managestudyfaq.php?deleteid=$id'>Turn On Visibility</a></td>"; ?> 
   <?php echo "<td><a href='managestudyfaq.php?deleteid2=$id'>Turn Off Visibility</a></td>"; ?> 
 
    <?php echo "<td><a href='managestudyfaq.php?deleteid3=$id'>Delete</a></td>"; ?> 
        <?php echo "<td><a href='reply4.php?id=$id'>reply</a></td>"; ?> 
...
if ($current_page != 1) {
 echo '<center><a href="managestudyfaq.php?s=' .
...
for ($i = 1; $i <= $pages; $i++) {
 if ($i != $current_page) {
 echo '<a href="managestudyfaq.php?s=' .
(($display * ($i - 1))) . '&p=' .
$pages . '">' . $i . '</a> ';
 } else {
 echo $i . ' ';
