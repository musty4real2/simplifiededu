...
//insert record in database
		$insert=$object->query("UPDATE `animal_stuff` SET `description`='$catname',`subject`='$subname',`content`='$content'  WHERE `id`='{$_POST['id']}'");
	header("location:manage_animal_stuff.php");	
	}

}
//fetch staff's record from db first
$staff=$object->query("SELECT * FROM `animal_stuff` WHERE `id`='{$_GET['id']}'");
