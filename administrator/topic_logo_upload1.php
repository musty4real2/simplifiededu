...
<div id="shell">
  ...
  <div id="main">
    <br/><br/>
    <h2>&nbsp;</h2>
    Please upload a Picture for the just Added category: <table width="100%" border="1" id="box-table-a">
    <tr width="100%">
      <td width="40%">
      
      <center>
  <div id="bar"><h3>Manage Topics</h3></div>

        <form action='ajaximage5.php' method="post" id="imageform" enctype="multipart/form-data">
