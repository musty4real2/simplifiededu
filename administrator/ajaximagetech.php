					...
					if($size<(1024*1024))
						{
							...
							if(move_uploaded_file($tmp, $path.$actual_image_name))
								...
								mysql_query("UPDATE `tech_stuff` SET `logo` = '$actual_image_name' WHERE `id`='{$_SESSION['voterid']}'") or die(mysql_error());
...
<?php echo "<p style='margin-top:45px; text-align:center;'><a  href='manage_tech_stuff.php?id={$_SESSION['voterid']}'>CLICK HERE TO FINISH</a></p>";
