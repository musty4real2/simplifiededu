...
<div id="shell">
  ...
  <div id="main">
    <br/><br/>
    <h2>&nbsp;</h2>
    Please upload a logo for the just selected Kiddies Article: <table width="100%" border="1" id="box-table-a">
    <tr width="100%">
      <td width="40%">
      
      <center>
  <div id="bar"><h3>Subjects</h3></div>

        <form action='ajaximage4.php' method="post" id="imageform" enctype="multipart/form-data">
