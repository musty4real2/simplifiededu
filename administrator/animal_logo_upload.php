...
<div id="shell">
  ...
  <div id="main">
    <br/><br/>
    <h2>&nbsp;</h2>
    Please upload a logo for the tech stuff you have just selected: <table width="100%" border="1" id="box-table-a">
    <tr width="100%">
      <td width="40%">
      
      <center>
  <div id="bar"><h3>ANIMAL STUFF IMAGE UPLOAD</h3></div>

        <form action='ajaximageanimal.php' method="post" id="imageform" enctype="multipart/form-data">
