...
<div id="shell">
  ...
  <div id="main">
    <br/><br/>
    <h2>&nbsp;</h2>
    Please upload a logo for the quick Grab you have just selected: <table width="100%" border="1" id="box-table-a">
    <tr width="100%">
      <td width="40%">
      
      <center>
  <div id="bar"><h3>Quick Grab</h3></div>

        <form action='ajaximagequick.php' method="post" id="imageform" enctype="multipart/form-data">
