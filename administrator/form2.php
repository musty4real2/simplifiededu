...
if(!empty($error)){
	...
	VALUES ('$catname','$tname','$introduction', '$objective', '$content', '$possiblequestions', '$reallifeapp', '$summary','$hdid','1')");
...
<?php echo $hd; ?>
<input type="hidden" name="hdid" value="<?Php echo $hd; ?>"/>
  <div id="bar">
