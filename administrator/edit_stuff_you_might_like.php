...
//insert record in database
		$insert=$object->query("UPDATE `stuff_you_might_like` SET `description`='$catname',`subject`='$subname',`content`='$content'  WHERE `id`='{$_POST['id']}'");
	header("location:manage_tech_stuff.php");	
	}

}
//fetch staff's record from db first
$staff=$object->query("SELECT * FROM `stuff_you_might_like` WHERE `id`='{$_GET['id']}'");
