...
move_uploaded_file($temp2,"uploaded/".$name2);
	...
	mysql_query("INSERT INTO `school` (`school_name`, `school_address`, `school_logo`, `entry_date`) VALUES ('$schoolname', '$schooladdress', '$name2', NOW())");
}
...
<table border="0" width="100%" height="321">
      <tr><td>&nbsp;</td></tr>
            ...
            <tr>
              ...
              <td><textarea name="schooladdress" rows="4" cols="18"/></textarea></td>
            </tr>
            <tr>
