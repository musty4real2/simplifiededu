...
<tr>
<td colspan="2">
<b style="float:right;">Welcome <?php echo $object->getPoster($_SESSION['postersid']); ?></b>
</td>
</tr>
  <tr>
    <td height="268"><center>>>><a href="history.php">View Your Tutorial History</a></center></td>
    <td><center>>>><a href="form.php"> Submit New Tutorial</a></center></td>
  </tr>
</table>
</center>
 <div class="cl">
