...
if($_GET['logout']==1){ echo "<h3 style='color:#F00;'>You have been logged out</h3>";
}
...
if(isset($_POST['button'])){
	...
	$select="SELECT * FROM `tutor_reg` WHERE `username`='$uname' AND `password`='$pword'";
...
$choose=mysql_query("Select `id` FROM `tutor_reg` WHERE `username`='$uname' AND `password`='$pword'");
...
<div id="bar"><h2>Login here</h2></div>
        
        
<table border="0" width="600" height="350px" bgcolor="#0071bc">
<tr class="none">
<td >
<table border="0" >
<tr class="none">
...
<td bgcolor="#FFFFFF" width="400px"><br/><br/>
