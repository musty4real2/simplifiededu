...
<?php
  ...
  $q = "SELECT * FROM `free_topics` WHERE `tutor_id`='{$_SESSION['postersid']}'";
  $r = mysql_query ($q);
...
?>
        <?php
		$get="SELECT * FROM `free_topics` WHERE `tutor_id`='{$_SESSION['postersid']}' ORDER BY `id` DESC LIMIT $start, $display ";
        ...
        <legend><b>View All Tutorials your have submitted to us</b>        <br/>
        you have submitted :<?php	$object->countRes('free_topics','tutor_id',$_SESSION['postersid']); ?> 
        <br/><?php
...
if ($current_page != 1) {
 echo '<center><a href="history.php?s=' .
