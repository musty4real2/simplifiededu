...
<head>
<title>Gmu e-Library|| Forumn</title>
...
<div id="shell">
  <div id="header">
    <h1 id="logo">
    <img src="forum/Logo_colord.png" /><a href="#">SIMPLIFIED EDUCATION<span>Strictly Education</span></a></h1>
  ...
  <div id="navigation">
    <ul>
      ...
      <div class="imgf"><li><img src="forum/forum_logo.png" height="90"/></li></div>
...
<span><a href="#"><?php echo $object->getPoster($_SESSION['postersid']); ?></a></span>
 <span class="wrote">wrote:</span>
            ...
            <td><a href="<?php echo "post.php?id=$id";?>" title="Like these Post" ><img src="../images/cancel.JPG" width="36" height="32" /><?php echo number_format($row['hits']).' '; ?> like (s) </a>  |<a href="<?php echo "comment.php?id=$id";?>" title="Comment on these Post" ><img src="../images/cancel.JPG" width="36" height="32" /> Comment</a></td>
