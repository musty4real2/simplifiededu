...
<head>
<title>Gmu e-Library||e-Learning contact us</title>
...
<div id="shell">
  ...
  <div id="main">
    <br/><br/>
    <h2><a href="howitworks.php">Contact Us</a></h2>
  
       CONTACT US via email : infocoreconcept@gmail.com<br/>OR
       <BR/>CALL US VIA THESE PHONE NUMBERS: 08076691323
       <BR/>YOU CAN VISIT OUR OFFICE AT : GIDAN MATASA OFF OKADA ROAD SUIT B1-6
      
        <br/>
        MINNA, NIGER STATE, NIGERIA.<br/>
        <br/>
        <br/>
        <center><embed src="contact.swf" width="343" height="231"></embed></center>
