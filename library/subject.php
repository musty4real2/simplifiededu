...
?>
  <img   class="pic " src="<?php echo "../logo/$picture";?>"  <?php echo $object->imageResize($pic[0], $pic[1], 100);?> alt="<?php echo $row['id'];?>" /><br/>
  <?php } 

if($picture==""){
$pic=getimagesize("../logo/info.jpg");
?>
  <img  class="pic" src="<?php echo "../logo/info.jpg";?>"  <?php echo $object->imageResize($pic[0], $pic[1], 100);?>  /><br/>
  <?php } ?>                    
                       <br />
