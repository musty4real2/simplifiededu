...
$sql = "SELECT `id`, `username`,`password` FROM `forumn_reg` WHERE `email`='$e' LIMIT 1";
...
$msg = '<h2>Hello '.$u.'</h2><p>This is an automated message from simplifiededu.com. If you did not recently initiate the Forgot Password process from our simplified forum, please disregard this email.</p><p>You indicated that you forgot your login password or username.<br/>
Username='.$u.'.<br/>.
password='.$p.'
...
echo "your username and password has been successfully sent to your mail please check your spam box for your username and password <a href='www.simplifiededu.com//forumn/'>LOGIN</a> ";
exit();
} else {
