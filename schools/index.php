...
if(isset($_POST['button'])){
	...
	$select="SELECT * FROM `sch_student_reg` WHERE `username`='$uname' AND `password`='$pword'";
...
$choose=mysql_query("Select * FROM `sch_student_reg` WHERE `username`='$uname' AND `password`='$pword'");
